...
- **⏰ 历史上的今天** - 回顾往年今日的记忆，感受时光流转
- **🎨 记忆卡片导出** - 精美复古风格卡片，支持分享到社交媒体
- **💬 AI 洛忆** - 智能伙伴为记忆生成温暖回应
- **📊 数据可视化** - 记忆统计、实体分布、情感分析
...
├── MemoryWeaver-Spec.md       # 产品需求文档
├── MemoryWeaver-Structure.md  # 架构设计文档
│
├── services/                  # 服务层
...
- **v1.0.0** (2026-04-12) - 初始发布，支持记忆录入、知识图谱、历史上的今天、记忆卡片导出
